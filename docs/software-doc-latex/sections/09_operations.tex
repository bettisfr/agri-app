...
Consistency between image files and annotation artifacts is another hygiene objective. Deletion workflows are designed to clean associated label and JSON files, but periodic audits remain recommended in long-running deployments.
