...
\begin{itemize}
  ...
  \item render list thumbnails and open full-resolution detail view;
...
Mode transitions are tested as workflows, not as isolated toggles. This means validating that, after switching network context, discovery, status retrieval, gallery access, and capture controls remain functional without manual repair steps.
