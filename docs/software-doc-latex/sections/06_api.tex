...
\texttt{/api/v1/health/checklist} & GET & Live checklist (RPi, ESP, camera, GPS, BME, storage) \\
...
\texttt{/health} & GET & Web live checklist page (RPi/ESP/camera/GPS/BME/storage) \\
